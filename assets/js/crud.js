...
$('#guardar_seguimiento').on('click', function (e) {
  ...
  const datos_formulario = $('#asignar_atributo').serializeArray();

  const datos_tabla = {
    atributo: datos_formulario[0].value,
    nombre: datos_formulario[1].value,
    sid_alumno: datos_formulario[2].value,
    fecha_seguimiento : datos_formulario[4].value,
    id: datos_formulario[3].value,
  };
  insertData('insertar', datos_tabla, 'asignar_atributo.php');
});
...
$('#mostrar_filtro_alumno').on('click', function (e) {
  e.preventDefault();

  const datos_formulario = $('#filtro_estudiante').serializeArray();

  const datos_tabla = {
    busqueda: datos_formulario[0].value,
    nivel: datos_formulario[1].value,
    grado: datos_formulario[2].value,
    grupo: datos_formulario[3].value,
    //id: datos_formulario[3].value,
  };
  // console.log(datos_formulario);
  filtros(datos_tabla, 'alumno.php');
});
...
$('#tabla_asignar_atributo').on('click', '.eliminar_fila', function (e) {
  e.preventDefault();

  const id_eliminar = $(this).attr('data-id');
  
  eliminar(id_eliminar, 'asignar_atributo.php');
});
//MODIFICAR
...
$('#tabla_asignar_atributo').on('click', '.editar_fila', function (e) {
  e.preventDefault();

  const id_modificar = $(this).attr('data-id');
 
  consulta('#tabla_asignar_atributo', id_modificar);
});


$('#exportar_excel_alumno').on('click', function (e) {
  e.preventDefault();
  ...
  console.log(datos_tabla);
  exportExcel(datos_tabla, 'alumno.php');
});
...
$('#tabla_seguimientos').on('click', '.mostrar_detalles', function (e) {
  e.preventDefault();
  ...
  consulta('#tabla_seguimientos', id_datos, 'detalles');
});

$('#tabla_extracurriculares').on('click', '.mostrar_detalles', function (e) {
  e.preventDefault();
  ...
  consulta('#tabla_extracurriculares', id_datos, 'detalles');
});
...
$(document).ready(function () {
  ...
  datos_select('#sid_nivel', 'nivel.php');
  //datos_select('#sid_rol', 'rol.php');
  datos_select('#sid_grado', 'grado.php');
  datos_select('#sid_tipo', 'tipo_mensaje.php');
  datos_select('#sid_estudiante', 'alumno.php');
  datos_select('#sid_grupo', 'grupo.php');
  datos_select('#sid_extracurricular', 'extracurricular.php');
  datos_select('#nivel_evento', 'nivel.php');
  datos_select('#grado_evento', 'grado.php');
  datos_select('#grupo_evento', 'grupo.php');
  datos_select('#asignar_atributo_seguimiento', 'atributo.php');
  datos_select('#filtro_nivel_alumno', 'nivel.php');
  datos_select('#filtro_grado_alumno', 'grado.php');
  datos_select('#filtro_grupo_alumno', 'grupo.php');
  datos_select('#extra_estudiante', 'alumno.php');
  ...
  consulta('#tabla_seguimientos', '');
  consulta('#tabla_asignar_atributo', '');
  consulta('#tabla_alumno_extracurricular', '');
